...
public class MainWindowViewModelTests
{
    ...
    {
        _vm.FirstArgument = 1;
        _vm.SecondArgument = Calculator.Epsilon / 10;
    ...
    public void HasErrors_ShouldBeFalse_WhenNumbersAndOperationAreValid(double firstArgument, double secondArgument,
        Operation operation)
    {
    ...
    [InlineData(1, 8.9, Operation.Multiply)]
    [InlineData(1, 3.5, Operation.Divide)]
    public void GetErrors_ShouldReturnEmptyCollection_WhenNumbersAndOperationAreValid(double firstArgument,
        double secondArgument, Operation operation)
    {
        _vm.FirstArgument = firstArgument;
        _vm.SecondArgument = secondArgument;
        _vm.SelectedOperation = operation;
    ...
    public void Result_ShouldBeExpected_WhenSumTwoNumbers(double firstArgument, double secondArgument, double expected)
    {
        _vm.FirstArgument = firstArgument;
        _vm.SecondArgument = secondArgument;
        _vm.SelectedOperation = Operation.Add;

        _vm.Result.Should().BeApproximately(expected, 1e-4);
    }
    ...
    public void Result_ShouldBeExpected_WhenSubtractTwoNumbers(double firstArgument, double secondArgument,
        double expected)
    {
        _vm.FirstArgument = firstArgument;
        _vm.SecondArgument = secondArgument;
    ...
    public void Result_ShouldBeExpected_WhenMultiplyTwoNumbers(double firstArgument, double secondArgument,
        double expected)
    {
        _vm.FirstArgument = firstArgument;
        _vm.SecondArgument = secondArgument;
    ...
    public void Result_ShouldBeExpected_WhenDivideTwoNumbers(double firstArgument, double secondArgument,
        double expected)
    {
        _vm.FirstArgument = firstArgument;
        _vm.SecondArgument = secondArgument;
